...
public class EnderecoResourceTests {
	...
	public void deleteSeDerErrado() throws Exception {
		ResultActions result = mockMvc.perform(delete("/enderecos/{id}",nonExistingId)
	...
	public void deleteSeDerCerto() throws Exception {
		ResultActions result = mockMvc.perform(delete("/enderecos/{id}",existingId)
		  .accept(MediaType.APPLICATION_JSON));
